    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "container"}, 
                ...
                React.createElement(ScoreRow, {score: self.props.amount1[0], onUpdate: self.onUpdate}), 
                React.createElement(ScoreRow, {score: self.props.amount1[1], onUpdate: self.onUpdate}), 
                React.createElement(ScoreRow, {score: self.props.amount1[2], onUpdate: self.onUpdate}), 
                React.createElement(ScoreRow, {score: self.props.amount1[3], onUpdate: self.onUpdate}), 
                React.createElement(ScoreRow, {score: self.props.amount1[4], onUpdate: self.onUpdate})
            )
        );
    }
});
...
React.render(
    React.createElement(ScoreBoard, {amount1: amount1}),
    document.body
);
