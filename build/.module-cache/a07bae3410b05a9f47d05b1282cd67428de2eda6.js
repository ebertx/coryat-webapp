    ...
    render: function() {
        ...
        return (
            React.createElement("div", {key: this.props.key, className: classes}, 
                ...
                React.createElement("a", {className: "correct", onClick: this.correctClick.bind(this, this.props.key)}, "✓"), 
                React.createElement("a", {className: "skipped", onClick: this.skippedClick.bind(this, this.props.key)}, "-"), 
                React.createElement("a", {className: "wrong", onClick: this.wrongClick(this.bind, this.props.key)}, "✗")
            )
        );
    }
});
