...
var ScoreBox = React.createClass({displayName: "ScoreBox",
    ...
    render: function() {
        var status = "two columns scoreBox " + this.state.status;
        return (
            React.createElement("div", {key: this.props.key, className: "{this.status}"}, 
                React.createElement("span", {className: "value"}, this.props.score), 
                React.createElement("a", {className: "right", onClick: this.rightClick}, "✓"), 
